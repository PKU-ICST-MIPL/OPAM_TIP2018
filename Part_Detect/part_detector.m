...
mainno = 2
imgRootDir = ''
listfilepath = './datalist/car_train_part.list';
actfilename = 'train_part_conv5_3/feature.txt';
partdir_prefix = ['Test_part_main' num2str(mainno) '_without_hxt'];
partdir_prefix
outdir = './parts/';
...
actMat = load(actfilepath);
actMat = actMat(1:length(pathlist),:);
