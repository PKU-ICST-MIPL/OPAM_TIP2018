function demoPascal2007(stimg, endimg)
...
VOCImgPath = 'D:\\v-tixi\\SelectiveSearchCodeIJCV\\Dataset\\VOCdevkit\\VOC2007\\JPEGImages\\%s.jpg'
...
fprintf('Time per image: %.2f\nNow evaluating the boxes on Pascal 2007...\n', totalTime ./(endimg-stimg+1));

filename = sprintf('Dataset\\boxes_%d.mat', floor(stimg / 500));
