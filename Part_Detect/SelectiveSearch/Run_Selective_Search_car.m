function Run_Selective_Search_car(threadNum , threadId)
...
% ks = ks(1:2);
imgroot = '/home/junchao/AAAI2016/dataset_car/car_ims/' ;
res_path = '/home/junchao/AAAI2016/datasets/ss_result_car/';
...
[imglist x1 y1 x2 y2] = textread('/home/junchao/AAAI2016/CNN-Saliency-Map-master/car/bbox.txt' , '%s %f %f %f %f') ;
...
filtering_out(threadNum , threadId) ;
end
